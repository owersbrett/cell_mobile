...
class GameCatalog {
  ...
  static const List<CatalogGame> games = [
    ...
    CatalogGame(id: 'isotopes', name: 'Isotopes', tagline: 'Dial protons and neutrons to build the nuclide', scale: BioScale.atoms, rank: GameRank.s, accent: Color(0xFF4DD0E1), icon: Icons.scatter_plot, specId: 'isotopes'),
    ...
    CatalogGame(id: 'nephron', name: 'Nephron', tagline: 'Drag the good back to blood, flick waste to urine', scale: BioScale.organ, rank: GameRank.b, accent: Color(0xFFC65A6E), icon: Icons.filter_alt, specId: 'nephron'),
    ...
    CatalogGame(id: 'electron_shells_v2', name: 'Energy Levels', tagline: 'Sort electrons by energy level — fill inside-out', scale: BioScale.atoms, rank: GameRank.b, accent: Color(0xFF4F9DFF), icon: Icons.track_changes, specId: 'electron_shells_v2'),
