...
import 'organelle/membrane_gate_v2/membrane_gate_v2_game.dart';
import 'atoms/half_life_v2/half_life_v2_game.dart';
import 'organelle/powerhouse_v2/powerhouse_v2_game.dart';
...
class MiniGameRegistry {
  ...
  static final List<MiniGameSpec> specs = [
    ...
    MiniGameSpec(
      id: 'membrane_gate_v2',
      name: 'Membrane Gate v2',
      scale: BioScale.organelle,
      tagline: 'Pull in what the cell needs — toxins get the ✕',
      rules: [
        'Tap the BRIGHT, glowing molecules (O₂, water, ions, glucose): +10.',
        'Catch them high for a PERFECT bonus; chain a streak up to ×6.',
        'NEVER tap the dull molecules marked ✕ — let them bounce off.',
        'Tap a toxin: streak lost + a brief import lockout.',
      ],
      howToWin: 'Most molecules imported when time runs out wins.',
      durationSeconds: 60,
      scoreUnit: 'molecules',
    ...
    MiniGameSpec(
      ...
      name: 'Powerhouse v2',
      scale: BioScale.organelle,
      tagline: 'Keep a self-breathing mitochondrion fed — fuel vs oxygen',
      rules: const [
        'The mitochondrion respires on its own — you do NOT tap it.',
        'Tap GLUCOSE (+1) and OXYGEN (+2) to feed the two tanks.',
        'No glucose when a cycle fires = MISFIRE (0 ATP).',
        'High oxygen = aerobic +12; low oxygen = anaerobic +4.',
        'Final 10s: OVERDRIVE — yields double, breathing speeds up.',
      ],
      howToWin: 'Most ATP produced when time runs out wins.',
      durationSeconds: 60,
      scoreUnit: 'ATP',
    ...
    MiniGameSpec(
      ...
      howToWin: 'Most check-ins when the 55s clock ends wins.',
      durationSeconds: 55,
      scoreUnit: 'check-ins',
      enabled: true,
      accent: const Color(0xFFE1C916),
    ...
    MiniGameSpec(
      ...
      name: 'Twitch v2',
      scale: BioScale.tissue,
      tagline: 'Fire on the beat — fuse twitches into tetanus before the muscle tires',
      rules: const [
        'Tap the signal in the strike zone: PERFECT = more force',
        'Mistime or miss a signal and the muscle relaxes — streak resets',
        'Stack fast hits past the TETANUS line for bonus force',
        'Held tetanus FATIGUES — relax to recover, then rebuild',
      ],
      howToWin: 'Most force when the 50 seconds run out — master build, hold, release, recover.',
      durationSeconds: 50,
      scoreUnit: 'force',
      enabled: true,
      accent: const Color(0xFFE05260),
    ...
    MiniGameSpec(
      ...
      name: 'Constants v2',
      scale: BioScale.universeAll,
      tagline: 'Hold the universe in the habitable band',
      rules: const [
        'Grab a dial and drag — the knob tracks your finger, no jumps.',
        'Keep ALL dials in their green bands: UNIVERSE HEALTH stays green.',
        'A surge telegraphs (amber ring + arrow) — catch it back in band for +60.',
        'Bands narrow, drift speeds up, surges quicken — climax crunch at the end.',
      ],
      howToWin: 'Most time life-permitting (all dials in band) plus surges caught wins.',
      durationSeconds: 55,
      scoreUnit: 'stability',
      enabled: true,
      accent: const Color(0xFF8B7CF6),
    ...
    MiniGameSpec(
      ...
      name: 'Heartbeat v2',
      scale: BioScale.organ,
      tagline: 'Pump in order, on the lub-dub',
      rules: const [
        'Tap the next chamber in order: Body→RA→RV→Lungs→LA→LV→Body.',
        'Atria fill on the DUB (mid-beat); every other stage pumps on the LUB (downbeat).',
        'Blue blood turns red at the lungs (oxygenated). Full cycle = +40.',
        'Wrong order, off-phase, or mistimed = stall (streak dips, not zeroed).',
      ],
      howToWin: 'Most pumps when time runs out wins.',
      durationSeconds: 55,
      scoreUnit: 'pumps',
      enabled: true,
      accent: const Color(0xFFE5484D),
